			...
			<div className={'flex gap-3 mt-2'}>
				...
				<a href={'https://www.linkedin.com/in/emma-lucas-0241b4155/'} target={'_blank'}>
					<svg width={25} height={25} viewBox={'0 0 16 16'}
						  className={'shadow-rose-400 hover:shadow-md opacity-70 hover:opacity-100 fill-(--foreground)'}>
				...
				<a href={'https://github.com/emlucas'} target={'_blank'}>
					<svg width={25} height={25} viewBox={'0 0 16 16'}
						  className={'shadow-rose-400 hover:shadow-md rounded-full opacity-70 hover:opacity-100 fill-(--foreground)'}>
